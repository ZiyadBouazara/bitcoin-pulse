...
//
//	mockgen -source=./domain/ports/ports.go -destination=./mocks/mock_ports.go -package=mocks
//
...
import (
	...
	domain "github.com/ZiyadBouazara/bitcoin-pulse/stockservice-go/internal/domain"
